...
Shader "ShaderBook/Chapter14/ToonShading"
{
    Properties
    {
    ...
    SubShader
    {
        Pass
        {
            ...
            {
                v2f o;
                //o.pos = UnityToClipPos(v.vertex);
                //将顶点和法线变换到视角空间（相机空间）下
                float4 pos = mul(UNITY_MATRIX_MV, v.vertex);
                float3 normal = mul((float3x3)UNITY_MATRIX_IT_MV,v.normal);
                //设置法线z轴，避免凹面模型法线外扩导致穿模
                normal.z = -0.5;
        ...
        // _SpecularScale("Specular Scale",Range(0,0.1)) = 0.01
            ...
            v2f vert_main_pass(a2v v)
            {
                ...
                // o.worldNormal = mul(v.normal,(flaot3x3)unity_WorldToObject);
